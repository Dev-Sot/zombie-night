...
export const SURVIVAL_DESC = {
  ...
  7: 'El patio de contenedores del puerto, en la niebla.',
  8: 'La escollera y el faro, rodeados de agua. No hay por dónde huir.',
  9: 'El muelle norte, con La Esperanza amarrada.',
  4: 'El parque frente al hospital, bajo la ceniza del incendio.',
  5: 'Adentro del hospital. Pasillos angostos y puertas que se rompen.',
  6: 'El estacionamiento de emergencias bajo la lluvia.',
  4: 'El parque frente al hospital, bajo la ceniza del incendio.',
